...
function buildDocs(config) {
  return {
    ...
    privacy: 'The posting IP address is recorded server-side for abuse mitigation only. It is never ' +
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .msg-id { color: var(--muted); font-family: ui-monospace, SFMono-Regular, Menlo, monospace; }
